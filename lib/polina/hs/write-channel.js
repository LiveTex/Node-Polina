...
polina.hs.WriteChannel.prototype.__sendCommand =
  ...
  var command = polina.hs.prepareCommand(args);
  this._send(polina.hs.encodeCommand(command),
...
polina.hs.WriteChannel.prototype.update =
  ...
  this.__findModify(operationType, value,
      polina.hs.ModifyOperationType.UPDATE, complete, cancel,
      opt_limit, opt_filters);
};
...
polina.hs.WriteChannel.prototype.delete =
    function(operationType, value, complete, cancel, opt_limit, opt_filters) {
  this.__findModify(operationType, value,
      polina.hs.ModifyOperationType.DELETE, complete, cancel,
      opt_limit, opt_filters);
};
