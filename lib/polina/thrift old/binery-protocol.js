...
polina.thrift.BinaryProtocol = function(idl) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.writeMessageBegin = function(methodName,
                                                                    type,
                                                                    seqid) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.serializeValue =
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.serializeStruct =
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.serializeMap =
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.serializeArray =
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.writeFieldBegin = function(type, id) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.writeFieldStop = function() {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.writeMapBegin = function(ktype, vtype,
                                                                size) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.writeListBegin = function(etype, size) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.writeSetBegin = function(etype, size) {
  return Buffer.concat([this.writeByte(etype),
                        this.writeI32(size)]);
};
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.readMessageHeader = function(cursor,
                                                                   chunk) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.readField= function(cursor, chunk) {
  ...
  console.log('id ', id);
  if (cursor.isParsed()) {
    return new polina.thrift.Field(name, type, id, this.__idl, this);
  } else {
    return null;
  }
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.readMapHeader = function(cursor, chunk) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.readListHeader = function(cursor, chunk) {
 ...
 * @inheritDoc
 */
polina.thrift.BinaryProtocol.prototype.readSetHeader = function(cursor, chunk) {
