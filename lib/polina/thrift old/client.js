...
polina.thrift.Client = function(user_idl, port, opt_host) {
  ...
  this.__idl = user_idl;
  this.__protocol = new polina.thrift.BinaryProtocol(user_idl);
};
 ...
 */
polina.thrift.Client.prototype.writeMethod = function(name, args, complete,
                                                      cancel, opt_returnType) {
  ...
  this._send(out, new polina.MessageHandler(complete, cancel,
