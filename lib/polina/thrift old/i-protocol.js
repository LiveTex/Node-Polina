...
/**
 * @param {polina.thrift.Int64} value
 * @return {!Buffer}
 */
 ...
 */
polina.thrift.IProtocol.prototype.readMessageHeader = function(cursor, chunk) {};


/**
 * @param {polina.Cursor} cursor
 * @param {Buffer} chunk
 * @return {polina.thrift.Field|null}
 */
polina.thrift.IProtocol.prototype.readField = function(cursor, chunk) {};
 ...
 */
polina.thrift.IProtocol.prototype.readMapHeader = function(cursor, chunk) {};
 ...
 */
polina.thrift.IProtocol.prototype.readListHeader = function(cursor, chunk) {};
 ...
 * @return {{type: number, size: number}|null}
 */
polina.thrift.IProtocol.prototype.readSetHeader = function(cursor, chunk) {};
