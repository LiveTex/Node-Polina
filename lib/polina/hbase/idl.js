...
polina.hbase.Idl = function() {
  ...
  this.mutation.addField('column', 2, polina.thrift.Types.STRING);
  this.mutation.addField('value', 3, polina.thrift.Types.STRING);
  this.mutation.addField('writeToWAL', 4, polina.thrift.Types.BOOL);
   ...
   * @type {polina.thrift.StructureInfo}
   */
  this.exception = new polina.thrift.StructureInfo('exception');
  this.exception.addField('message', 1, polina.thrift.Types.STRING);
};
