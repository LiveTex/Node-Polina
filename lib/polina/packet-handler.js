...
/**
 * @param {!function(!polina.Packet, !polina.Cursor, !Buffer,
 *  !Array.<*>=): boolean} parser
 * @param {!function(!polina.Packet)} resultHandler
 * @param {!Array.<*>=} opt_args
 * @constructor
 */
polina.PacketHandler = function(parser, resultHandler, opt_args) {
   ...
   * @type {!polina.Packet}
   */
  this.__result = new polina.Packet();
