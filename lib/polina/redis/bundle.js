...
polina.redis.Bundle.prototype.persist = function(key, complete, cancel) {
  this.__currentClient.persist(key, complete, cancel);
  this.__updateCurrentClient();
};
...
polina.redis.Bundle.prototype.hdel = function(key, hkey, complete, cancel) {
  this.__currentClient.hdel(key, hkey, complete, cancel);
  this.__updateCurrentClient();
};
...
polina.redis.Bundle.prototype.hget = function(key, hkey, complete, cancel) {
  this.__currentClient.hget(key, hkey, complete, cancel);
  this.__updateCurrentClient();
};
...
polina.redis.Bundle.prototype.hset =
  ...
  this.__currentClient.hset(key, hkey, value, complete, cancel);
  this.__updateCurrentClient();
};
 ...
 * @inheritDoc
 */
polina.redis.Bundle.prototype.evalsha = function(name, args, complete, cancel) {
  this.__currentClient.evalsha(name, args, complete, cancel);
  this.__updateCurrentClient();
};
...
polina.redis.Bundle.prototype.scriptLoad = function(name, script) {
  this.__currentClient.scriptLoad(name, script);
  this.__updateCurrentClient();
};
