...
polina.redis.PacketHandler.prototype._complete = function() {
  ...
  process.nextTick(function() {
    if (self.__resultType === 0) {
      self.__resultHandler(self.__intResult);
    } else if (self.__resultType === 1) {
      self.__resultHandler(self.__stringResult);
    } else if (self.__resultType === 2) {
      self.__resultHandler(self.__arrayResult);
    }
  });
