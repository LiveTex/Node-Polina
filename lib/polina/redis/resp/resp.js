...
//  console.log('BULK: LENGTH:', length, 'START:', start, 'STOP:', stop, 'CHUNK.LEN:', chunk.length, stop < chunk.length);
...
//  console.log('RESULT:', packet.isCompleted(), cursor.getPosition(), chunk.length, '\n----');
