 ...
 */
polina.thrift.MapValue = function(type, valueInfo, isError, idl) {
   ...
   */
  this.__keyType = valueInfo.getKInfo();

  /**
   * @type {!polina.thrift.FieldType}
   */
  this.__valType = valueInfo.getVInfo();
...
polina.thrift.MapValue.prototype.process = function(cursor, chunk, protocol) {
  ...
  if (this.__header === null) {
    this.__header = protocol.readMapHeader(cursor, chunk);
    if (this.__header !== null &&
 ...
 * @inheritDoc
 */
polina.thrift.MapValue.prototype.getInt64 = function() {
  return 0;
};
 ...
 * @inheritDoc
 */
polina.thrift.MapValue.prototype.getNumber = function() {
  return 0;
};
