...
polina.thrift.writeFieldBegin = function(type, id){
  return polina.thrift.__protocol.writeFieldBegin(type, id);
};
polina.thrift.writeFieldEnd = function(){};
polina.thrift.writeFieldStop = function(){
  return polina.thrift.__protocol.writeFieldStop();
};
...
polina.thrift.writeI16 = function(value){
  return polina.thrift.__protocol.writeI16(value);
};

polina.thrift.writeI32 = function(value){
  return polina.thrift.__protocol.writeI32(value);
};
...
polina.thrift.writeString = function(value){
  return polina.thrift.__protocol.writeString(value);
};
...
polina.thrift.readBool = function(cursor, chunk){
  return polina.thrift.__protocol.readBool(cursor, chunk);
};
//bool = readBool()
