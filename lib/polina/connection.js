...
polina.Connection = function(port, opt_host) {
  ...
  /**
   * @type {!Array.<!polina.PacketHandler>|!ds.queue.Queue}
   */
...
/**
 * @return {boolean} Is request in process.
 */
...
polina.Connection.prototype.destroy = function() {
  if (this.__socket !== null) {
    ...
    this.__socket.end(this._getDestroyPayload());
    this.__socket = null;
  }
};
 ...
 * @param {!polina.PacketHandler} handler Packet handler.
 */
 ...
 * @return {string} Initializes request.
 */
polina.Connection.prototype._getDestroyPayload = function() {
  return '';
};
