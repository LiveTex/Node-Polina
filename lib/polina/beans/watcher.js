...
polina.beans.Watcher = function(tube) {
  polina.beans.Client.call(this,
      'quit\r\n',
      'watch ' + tube.getName() + '\r\n',
      new polina.beans.PacketHandler('WATCHING', polina.nop, polina.nop),
      tube.getPort(), tube.getHost());

  /**
   * @type {string}
   */
  this.__currentJid = polina.beans.EMPTY_JID;
...
polina.beans.Watcher.prototype.reserve = function(complete, cancel) {
  ...
  this._command('reserve', '', polina.beans.Status.RESERVED,
      function(jid, data) {
 ...
 */
polina.beans.Watcher.prototype.delete = function(jid, complete) {
  var self = this;

  this._command('delete', jid, 'DELETED', function(jid, data) {
    self.__resetJobId();
    complete();
  }, function(error) {
...
polina.beans.Watcher.prototype.release =
    function(jid, priority, timeout, complete) {
  var self = this;
...
polina.beans.Watcher.prototype.destroy = function() {
  ...
  if (this.__currentJid === polina.beans.EMPTY_JID) {
