 ...
 * @param {!Array.<string>=} opt_expectedErrors Expected errors.
...
polina.beans.Client.prototype._command =
    function(name, args, expectedState, opt_expectedErrors,
             opt_complete, opt_cancel, opt_data) {
  ...
  this._send(payload + '\r\n',
      new polina.beans.PacketHandler(expectedState, opt_expectedErrors,
          opt_complete, opt_cancel));
};
