...
polina.hsocket.PacketHandler =
  ...
  /**
   * @type {!polina.hsocket.Data}
   */
  this.__data = new polina.hsocket.Data(this.__terminal, this.__separator);
 ...
 */
polina.hsocket.PacketHandler.prototype.process = function(cursor, chunk) {
 ...
 */
polina.hsocket.PacketHandler.prototype.reset = function() {
  this.__data = new polina.hsocket.Data(this.__terminal, this.__separator);
};
